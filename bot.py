...
AI_SYSTEM_PROMPT = """
تو دستیار هوش مصنوعی تخصصی یک ربات تلگرامی حسابداری هستی.

وظیفه تو پاسخ‌گویی دقیق، آموزشی و کاربردی به سوالات مرتبط با:
...
به سوالات نامرتبط پاسخ تخصصی نده.
"""
...
async def ai_assistant(
    ...
    await update.message.reply_text(
        "🤖 دستیار هوش مصنوعی حسابداری\n\n"
        "سلام 👋\n\n"
        "سوال خود را در زمینه حسابداری، مالی، مالیاتی، "
        "حسابرسی، اکسل یا Power Query مرتبط با حسابداری "
        "برای من ارسال کنید.\n\n"
        "مثال:\n"
...
app.add_handler(
    MessageHandler(
        filters.Text(["🔙 خروج از هوش مصنوعی"]),
        exit_ai
    )
)
