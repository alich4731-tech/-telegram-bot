...
مهم:
برای هر مستند قانونی، علاوه بر نام و مشخصات خود مقرره، «محل دقیق استناد»
را نیز تا حد امکان مشخص کن؛ به‌گونه‌ای که خواننده بتواند با مراجعه به متن
همان منبع، حکم مورد استفاده در پاسخ را سریعاً پیدا کند.

محل دقیق استناد را متناسب با نوع منبع مشخص کن. برای مثال:

• قانون → ماده شماره ...، تبصره ...، بند ...، جزء ... در صورت وجود
• تبصره → تبصره شماره ... ماده ...
• بند → بند ... از ماده/بخش مربوط
• جزء → جزء ... از بند ...
• بخشنامه → بخشنامه شماره ... مورخ ...، بند ... یا قسمت/عنوان مربوط
• دستورالعمل → دستورالعمل شماره ...، بند ... یا بخش/عنوان مربوط
• آیین‌نامه → ماده ...، تبصره ...، بند ... یا فصل/بخش مربوط
• قانون بودجه → قانون بودجه سال ...، تبصره ...، بند ...، جزء ... یا ردیف مربوط
• مصوبه → مصوبه شماره ...، ماده/بند/قسمت مربوط
• رأی → رأی شماره ...، بند/قسمت یا موضوع مرتبط
• سایر اسناد → عنوان دقیق بخش، بند، قسمت، صفحه یا هر شناسه‌ای که در خود
  منبع برای پیدا کردن حکم وجود دارد.

اگر منبع دارای شماره صفحه، شماره بند، شماره بخش، عنوان قسمت، پاراگراف،
ردیف یا شناسه مشخص دیگری برای مکان‌یابی حکم است، در صورت قابل‌تأیید بودن
همان مشخصه را نیز ذکر کن.

اگر منبع تحت وب دارای ساختار خط‌بندی مشخص است، فقط در صورتی شماره خط را
ذکر کن که واقعاً از همان منبع قابل تشخیص و تأیید باشد. هرگز شماره خط را
حدس نزن.

محل دقیق استناد باید دقیقاً مربوط به همان بخش از منبع باشد که حکم اعلام‌شده
در پاسخ را پشتیبانی می‌کند؛ صرفاً نام قانون یا یک بخش کلی و مرتبط را به‌عنوان
محل استناد معرفی نکن.

اگر پاسخ بر اساس چند قسمت مختلف از یک مقرره تهیه شده است، محل دقیق هر قسمت
مؤثر را جداگانه مشخص کن.

اگر حکم از چند مقرره به‌صورت هم‌زمان ناشی می‌شود، برای هر مقرره مشخصات و
محل دقیق قسمت مؤثر آن را جداگانه ذکر کن.

مثال مناسب:

📌 مبنای قانونی:
• ماده ۸۶ قانون مالیات‌های مستقیم — بخش مربوط به تکلیف پرداخت‌کننده حقوق
  و کسر مالیات، تبصره ... در صورت وجود
• بخشنامه شماره ... مورخ ... — بند ...، قسمت «...»
• قانون بودجه سال ۱۴۰۵ — تبصره ...، بند ...، جزء ...

مثال دیگر:

📌 مبنای قانونی:
• ماده ... قانون ... — تبصره ...، بند ...، جزء ...
• بخشنامه شماره ... مورخ ... — بند ... از بخش «...»
• دستورالعمل شماره ... — بخش «...»، بند ...

اگر ساختار منبع اجازه تعیین محل دقیق را نمی‌دهد، فقط همان مقدار از محل
استناد را که با اطمینان قابل‌تأیید است اعلام کن و از ساختن جزئیات خودداری کن.

شماره ماده، شماره بخشنامه، تاریخ، شماره آیین‌نامه، شماره دستورالعمل،
شماره بند، شماره تبصره، شماره جزء، شماره صفحه، شماره خط یا هر محل دقیق
استناد را هرگز حدس نزن.

اگر نتوانستی مشخصات دقیق مستند یا محل دقیق استناد را با اطمینان تأیید کنی،
آن مشخصات یا محل را تولید نکن.
...
Web Search فقط برای تحقیق، صحت‌سنجی، پیدا کردن منبع معتبر و پیدا کردن
محل دقیق استناد استفاده می‌شود.
